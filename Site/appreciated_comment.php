...
<html>
    ...
    $sqlQuery = 'SELECT NOM_JEU FROM JEUX ORDER BY NOM_JEU ASC';
    ...
    $sqlQueryAvis = "SELECT NOTE_AVIS, NB_JOUEUR, PSEUDO_JOUEUR, COMMENTAIRE_AVIS, DATE_AVIS, ID_AVIS 
                     FROM JOUEURS as J natural join AVIS as A natural join CONFIGURATIONS as C 
                     natural join JEUX where NOM_JEU ='$jeu' ";

    $avisStatement = $db->prepare($sqlQueryAvis);  
    $avisStatmentQuery = $db->query($sqlQueryAvis);
